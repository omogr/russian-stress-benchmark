...
- Предполагается, что библиотека расстановки ударений не должна менять исходный текст, а только должна добавлять знаки ударений. Если в результате разметки ударений в предложении появились или исчезли какие-то слова, то никаких сложных алгоритмов выравнивания слов в предложениях не используется, учитываются только неизменившиеся слова от начала и от конца предложения. Остальные слова считаются несопоставившимися.
